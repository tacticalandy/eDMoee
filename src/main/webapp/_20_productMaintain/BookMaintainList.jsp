...
<div id="insert"><a href="<c:url value='/_20_productMaintain/BookPreInsert.do' />" >新增紀錄</a></div>
			...
			<table border='1' width='600'>
				<tr>
					<td width='600' align="left">書名：<a
						href="BookPreUpdate.do?BOOKID=${aBookBean.bookId}&pageNo=${pageNo}">${aBookBean.title}</a>
